...
export default function OpinionWidget({ className }: { className?: string }) {
  return (
    <div className={`${className ?? 'relative lg:absolute lg:top-[2898px] lg:left-[1041px]'} w-full lg:w-[301px] h-auto lg:h-[430px] bg-[url('/images/v47_941.png')] bg-no-repeat bg-center bg-cover overflow-hidden`}>
      <div className="relative top-[0px] left-[0px] w-[171px] h-auto lg:h-[29px] bg-[url('/images/v47_942.png')] bg-no-repeat bg-center bg-cover overflow-hidden">
        <div className="relative top-[0px] left-[0px] w-[171px] h-auto lg:h-[29px] bg-[url('/images/v47_943.png')] bg-no-repeat bg-center bg-cover overflow-hidden">
          <div className="lg:top-[3px] lg:left-[40px] w-[131px] h-auto lg:h-[17px] bg-[url('/images/v47_944.png')] bg-no-repeat bg-center bg-cover overflow-hidden lg:absolute">
            <span className="relative top-[0px] left-[0px] w-[90px] text-[#ffad15] font-['Rasa'] font-bold text-[23px] lg:text-[28px] text-center">
              {"ઓપીન્યન"}
            </span>
            <div className="lg:top-[7px] lg:left-[95px] w-[36px] h-auto lg:h-[9px] bg-[url('/images/v47_946.png')] bg-no-repeat bg-center bg-cover overflow-hidden lg:absolute">
          ...
          <div className="relative top-[0px] left-[0px] w-[30px] h-[29px] bg-[url('/images/v47_951.png')] bg-no-repeat bg-center bg-cover overflow-hidden" />
        </div>
      </div>
      <div className="lg:top-[44px] lg:left-[1px] w-full lg:w-[300px] h-auto lg:h-[386px] bg-[url('/images/v47_952.png')] bg-no-repeat bg-center bg-cover overflow-hidden lg:absolute">
        <div className="relative top-[0px] left-[0px] max-lg:relative max-lg:grid max-lg:grid-cols-[59px_1fr] max-lg:items-center max-lg:gap-[12px] w-full lg:w-[300px] h-auto lg:h-[108px] bg-[url('/images/v47_953.png')] bg-no-repeat bg-center bg-cover overflow-hidden">
          ...
          <span className="lg:top-[80px] lg:left-[108px] max-lg:col-start-2 max-lg:row-start-2 max-lg:w-auto max-lg:min-w-0 w-[95px] text-[#000000a6] font-['Hind_Vadodara'] font-normal text-[14px] text-left lg:absolute block">
            {"એમ. જે અકબર"}
          </span>
          <span className="lg:top-[78px] lg:left-[88px] max-lg:hidden w-[18px] text-[#ff0000] font-['Rasa'] font-bold text-[45px] text-left lg:absolute block">
            {"“"}
          </span>
        </div>
